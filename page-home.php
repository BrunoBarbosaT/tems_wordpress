...
<div id="content" class="site-content">
    <div id="primary" class="content-area">
        <main id="main" class="site-main">
                ...
                <div class="overlay" style="min-height: <?php echo esc_attr( $hero_height ) ?>px">
                    <div class="container">
                        <div class="hero-items">
                            ...
                            <a
                                href="<?php echo esc_url( $hero_button_link ) ?>"><?php echo esc_html( $hero_button_text ); ?></a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <h2><?php esc_html_e( 'Trocar de contador é Fácil', 'wp-devs' ) ?></h2>
                <div class="container">
                    <div class="services-item">
                        <?php 
                                    if( is_active_sidebar( 'services2-1' )){
                                        dynamic_sidebar( 'services2-1' );
                                    }
                                ?>
                    </div>
                    <div class="services2-item">
                        <?php 
                                    if( is_active_sidebar( 'services2-2' )){
                                        dynamic_sidebar( 'services2-2' );
                                    }
                                ?>
                    </div>
                    <div class="services2-item">
                        <?php 
                                    if( is_active_sidebar( 'services2-3' )){
                                        dynamic_sidebar( 'services2-3' );
                                    }
                                ?>
                    </div>
                </div>
